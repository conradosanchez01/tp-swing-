...
public class Mavenproject2 {
   ...
   /* // 1. Creamos la ventana principal (JFrame) y le damos tamaño
        ...
        ventana.setSize(400, 200); // Ancho y alto en píxeles
        ventana.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // Para que cierre el proceso al tocar la X
        
        // 2. Creamos el contenedor intermedio (JPanel)
        JPanel panel = new JPanel();
        ventana.add(panel); // Añadimos el panel a la ventana
    ...
    // 4. Creamos el botón y la etiqueta vacía para el resultado
        ...
        JLabel etiquetaResultado = new JLabel(""); // Arranca vacía
    ...
    // 5. Interacción: Implementamos el ActionListener para el botón
        botonSaludar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // Recogemos el texto que escribió el usuario
                String nombre = campoNombre.getText();
                
                // Modificamos la etiqueta inferior para mostrar el saludo
                etiquetaResultado.setText("¡Hola, " + nombre + "!");
            }
        });

        // Hacemos visible la ventana al final de todo
